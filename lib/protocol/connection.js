...
Connection.prototype._initializeSettingsManagement = function _initializeSettingsManagement(settings) {
  ...
  var newSetting = {};
  assign(newSetting, defaultSettings);
  assign(newSetting, settings);
  ...
  this.emit('RECEIVING_SETTINGS_MAX_CONCURRENT_STREAMS', newSetting.SETTINGS_MAX_CONCURRENT_STREAMS);
};
